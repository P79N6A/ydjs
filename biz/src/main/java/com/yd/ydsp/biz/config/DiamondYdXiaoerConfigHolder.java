 ...
 * @date 18/06/19
 */
public class DiamondYdXiaoerConfigHolder {
    static final DiamondYdXiaoerConfigHolder instance = new DiamondYdXiaoerConfigHolder();
    public static DiamondYdXiaoerConfigHolder getInstance(){ return instance; }
