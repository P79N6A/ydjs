package com.yd.ydsp.biz.pay.yeepay.utils;
...
public class PaymobileUtils {
	...
	public static final Logger logger = LoggerFactory.getLogger(PaymobileUtils.class);
	
	//配置文件路径
	public static final String CONFIG_FILE_PATH			= "com/yd/ydsp/resources/merchantInfo";
...
//	private static String merchantaccount		= DiamondYdSystemConfigHolder.getInstance().yeepayMerchantaCcount;
//	private static String merchantPrivateKey	= DiamondYdSystemConfigHolder.getInstance().yeepayMerchantPrivateKey;
//	private static String yeepayPublicKey		= DiamondYdSystemConfigHolder.getInstance().yeepayPublicKey;
...
//	}
	...
	//生成密文：data
	public static String buildData(TreeMap<String, Object> treeMap, String AESKey,String merchantaccount,String privateKey) {
		...
		//生成sign，并将其放入treeMap
		String sign			= buildSign(treeMap,privateKey);
	...
	//一键支付post请求
	public static TreeMap<String, Object> httpPost(String url, String merchantaccount, String data, String encryptkey) {
		...
		logger.info("yeePay httpPost url is :"+ url);
		logger.info("yeePay httpPost responseBody is: "+ responseBody);
		result				= JSON.parseObject(responseBody, new TypeReference<TreeMap<String, Object>>() {});
		
		return result;
	}
	
	//get请求
	public static TreeMap<String, Object> httpGet(String url, String merchantaccount, String data, String encryptkey) {
		...
		logger.info("yeePay httpGet url is :"+ url);
		logger.info("yeePay httpGet responseBody is: "+ responseBody);
		result				= JSON.parseObject(responseBody, new TypeReference<TreeMap<String, Object>>() {});
	...
	//sign验签
	public static boolean checkSign(String params, String signYeepay, String yeepayPublicKey) {
...
//
//		//result为true时表明验签通过
//		boolean result = checkSign(buffer.toString(), signYeepay);
//
//		return result;
//	}

	// sign验签
	public static boolean checkSign(TreeMap<String, Object> dataMap,String yeepayPublicKey) {

		//获取明文参数中的sign。
		String signYeepay	= StringUtils.trimToEmpty((String)dataMap.get("sign"));

		//将明文参数中sign之外的其他参数，拼接成字符串
		StringBuffer buffer	= new StringBuffer();
		for(Entry<String, Object> entry : dataMap.entrySet()) {
			String key		= formatStr(entry.getKey());
			String value	= formatStr((String)entry.getValue().toString());
			if("sign".equals(key)) {
				continue;
			}
			buffer.append(value);
...
//		dataMap.put("aaa","afafafaf");
//		dataMap.put("bbb",12345678);
//		dataMap.put("ccc",1234567899999999L);
//		dataMap.put("sign","asdfafafasfafafasfafa444444");
//		checkSign(dataMap);
