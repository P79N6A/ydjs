...
public class HtmlTagBalance implements HtmlConverter{
	...
	class HtmlFilterDocumentHandler extends DefaultFilter {
		...
		/** doctype process*/
		public void doctypeDecl(String root, String publicId, String systemId, 
		                        Augmentations augs) throws XNIException {
		    String docType = "!DOCTYPE ";
		      String publicTag = "PUBLIC ";
		      String quotation = "\"";
		      fwriterBuffer.append("<").append(docType)
		      .append(root).append(" ")
		      .append(publicTag).append(quotation).append(publicId).append(quotation)
		      .append(" ").append(quotation).append(systemId).append(quotation);
		      if(augs != null){
		          fwriterBuffer.append(" ")
		          .append(quotation).append(augs.toString()).append(quotation);
		      }
		      fwriterBuffer.append(">");
		}
	...
	public class FragmentXppParser extends HTMLConfiguration {
		...
		public FragmentXppParser() {
			...
			this.setProperty(DEFAULT_ENCODING_PROPERTY,
		...
		public void parse(InputSource source) throws SAXException, IOException {
			...
			try {
				...
				XMLInputSource inputSource = new XMLInputSource(pubid, sysid,
						sysid);
