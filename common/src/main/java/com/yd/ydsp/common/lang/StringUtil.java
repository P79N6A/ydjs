...
public class StringUtil {
    ...
    public static boolean containsOnly(String str, String valid) {
        return str != null && valid != null?containsOnly(str, (char[])valid.toCharArray()):false;
    }
     ...
     * @return
     */
    public static String abbreviateComplete(String str, int maxWidth,boolean isChinese,boolean isPre,boolean onlySpc) {
        if(str==null){
            return null;
        }
        String result = str;
     ...
     * @return
     */
    public static String abbreviate2BComplete(String str,boolean isChinese,String addStr) {
        if (str == null) {
            return "";
        }
        String result = str;
...
//            }
//        }
        return StringUtil.abbreviateComplete(addStr,29-mod,true,true,true);
    }
    ...
    public static boolean StrIsJson(String str){
        ...
        String lastStr = StringUtil.substring(str,str.length()-1);
        if((StringUtil.equals("{",firstStr)&&(StringUtil.equals("}",lastStr)))||(StringUtil.equals("[",firstStr)&&(StringUtil.equals("]",lastStr)))){
            return true;
        }else {
            return false;
        }
    ...
    public static String mobleReplace(String mobile){
        String beginStr = mobile.substring(0,3);
        String endStr = StringUtil.substring(mobile,mobile.length()-3);
