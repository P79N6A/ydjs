...
import com.yd.ydsp.common.lang.enumeration.CreateEnumException;
import com.yd.ydsp.common.lang.enumeration.EnumUtil;
import com.yd.ydsp.common.lang.enumeration.Flags;
import com.yd.ydsp.common.lang.enumeration.internal.NumberType;
...
public abstract class Enum extends Number implements NumberType, Comparable, Serializable {
    ...
    private static Enum createEnum(String name, Number value, boolean withValue) {
        ...
        try {
            ...
            throw new CreateEnumException("Could not find enum class " + enumClassName, var8);
        } catch (Exception var9) {
            throw new CreateEnumException("Could not instantiate enum instance of class " + enumClassName, var9);
        }
    ...
    public int compareTo(Object otherEnum) {
        if(!this.getClass().equals(otherEnum.getClass())) {
            throw new CreateEnumException(MessageFormat.format("Could not compare object of \"{0}\" with object of \"{1}\"", new Object[]{this.getClass().getName(), otherEnum.getClass().getName()}));
        } else {
    ...
    public boolean equals(Object obj) {
        return obj == this?true:(obj != null && this.getClass().equals(obj.getClass())?this.value.equals(((Enum)obj).value):false);
    }
                    ...
                    if(Modifier.isPublic(modifier) && Modifier.isFinal(modifier) && Modifier.isStatic(modifier)) {
                        try {
                            ...
                            while(j.hasNext()) {
                                ...
                                if(e == enumObject && enumObject.name == null) {
                            ...
                            throw new CreateEnumException(var11);
                        }
                    }
                }
